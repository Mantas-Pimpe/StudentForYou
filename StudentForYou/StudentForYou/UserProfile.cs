...
//        {
//            InitializeComponent();
//            userData = db.GetUser(user.userID);
//            label1.Text = label1.Text + userData.username;
//            UserName.Text = userData.username;
//            UserInfo.Text = userData.userBio;
//            newUsername = userData.username;
//            roundPicturebox1.Image = userData.userImage;
...
//        {
//            db.UpdateUser(new User(userData.userID, newUsername, UserInfo.Text, userData.userCreationDate, userData.userImage));
//            Application.Restart();
//        }
...
//        {
//            var profileLogic = new Profile();
//            var newPictureFilePath = profileLogic.PictureChange();
//            db.InsertImage(userData, newPictureFilePath);
//            userData = db.GetUser(userData.userID);
//            roundPicturebox1.Image = userData.userImage;
//        }

//        private void Coursebtn_Click(object sender, EventArgs e)
//        {
//            var subjects = new form1(userData);
//            subjects.Show();
//            this.Close();
//        }
...
//        {
//            var rpf = new RecentQuestions(userData);
//            rpf.Show();
//            this.Close();
//        }
